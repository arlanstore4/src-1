...
wget -q -O /usr/bin/cek-ws "https://raw.githubusercontent.com/arlanstore/src/ipuk/xray/cek-ws.sh" && chmod +x /usr/bin/cek-ws
wget -q -O /usr/bin/renew-ws "https://raw.githubusercontent.com/arlanstore/src/ipuk/xray/renew-ws.sh" && chmod +x /usr/bin/renew-ws
wget -q -O /usr/bin/crtv2ray "https://raw.githubusercontent.com/arlanstore/src/ipuk/xray/crt.sh" && chmod +x /usr/bin/crtv2ray
wget -q -O /usr/bin/add-ssws "https://raw.githubusercontent.com/arlanstore/src/ipuk/xray/add-ssws.sh" && chmod +x /usr/bin/add-ssws
sleep 1
